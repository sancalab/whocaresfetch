...
def whocaresfetch():
    ...
    print(colorize_text("whocaresfetch", 'OKBLUE'))
    ...
    print(colorize_text(f"Distribution: {dist_info['id']} {dist_info['version']}", 'OKCYAN'))
    print(colorize_text(f"Codename: {dist_info['codename']}", 'OKCYAN'))
